  ...
  return (
    <div className="container my-5">
      ...
      <div data-custom-class="body">
        <div><strong><span style={{ fontSize: '26px' }}><span
        ...
        <strong>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="subtitle">
              Last updated
              <bdt className="question">September 12, 2021</bdt>
            </span>
          </span>
        </strong>
      </span>
      ...
      <span style={{ color: 'rgb(127, 127, 127)' }}>
        <span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
          <span data-custom-class="body_text">
            Thank you for choosing to be part of our community at us. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice or our practices with regard to your personal information, please contact us at quanghuytran.hust@gmail.com.
          </span>
        </span>
      </span>
        </div>
        <div style={{ lineHeight: '1.5' }}><span
          style={{ fontSize: '15px' }}><br /></span></div>
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}><span
            style={{ color: 'rgb(127, 127, 127)' }}><span
            data-custom-class="body_text">This privacy notice describes how we might use your information if you:</span></span></span>
          <span style={{ fontSize: '15px' }}>
        <span style={{ color: 'rgb(127, 127, 127)' }}>
          <span data-custom-class="body_text">
          ...
          <span style={{ fontSize: '15px' }}>
            ...
            <div style={{ lineHeight: '1.5' }}>
              <span style={{ fontSize: '15px' }}><span
                style={{ color: 'rgb(127, 127, 127)' }}><span
                data-custom-class="body_text">In this privacy notice, if we refer to:</span></span></span>
              <span style={{ fontSize: '15px' }}>
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span data-custom-class="body_text">
                <span style={{ color: 'rgb(89, 89, 89)' }}>
              ...
              <ul>
                <li style={{ lineHeight: '1.5' }}>
                  <span
                    ...
                    style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}><span
                    data-custom-class="body_text">"<strong>App</strong>," we are referring to any application of ours that references or links to this policy, including any listed above</span></span></span>
                  <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: '15px' }}>
              ...
              <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                  ...
                  <span style={{ fontSize: '15px' }}><span
                    style={{ color: 'rgb(127, 127, 127)' }}><span
                    data-custom-class="body_text"> App,</span></span></span>
                  <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    <span
              ...
              <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: '15px' }}>
              <a data-custom-class="link" href="#infocollect"><span
              ...
              <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: '15px' }}>
              <span style={{ color: 'rgb(89, 89, 89)' }}><a
                data-custom-class="link" href="#infoshare">2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a></span>
              <span style={{ color: 'rgb(127, 127, 127)' }}>
                <span style={{ color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: 'rgb(89, 89, 89)' }}>
              ...
              <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: '15px' }}>
              <a data-custom-class="link" href="#3pwebsites"><span
                style={{ color: 'rgb(89, 89, 89)' }}>3. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</span></a>
              <span style={{ color: 'rgb(127, 127, 127)' }}>
                <span style={{ color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: 'rgb(89, 89, 89)' }}>
              ...
              <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: '15px' }}>
              <a data-custom-class="link" href="#inforetain"><span
                style={{ color: 'rgb(89, 89, 89)' }}>4. HOW LONG DO WE KEEP YOUR INFORMATION?</span></a>
              <span style={{ color: 'rgb(127, 127, 127)' }}>
                <span style={{ color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: 'rgb(89, 89, 89)' }}>
              ...
              <div style={{ lineHeight: '1.5' }}><span
                ...
                style={{ color: 'rgb(89, 89, 89)' }}><a data-custom-class="link"
                                                        href="#privacyrights">5. WHAT ARE YOUR PRIVACY RIGHTS?</a></span></span>
              </div>
              <div style={{ lineHeight: '1.5' }}><span
                style={{ fontSize: '15px' }}><a data-custom-class="link"
                                                href="#DNT"><span
                style={{ color: 'rgb(89, 89, 89)' }}>6. CONTROLS FOR DO-NOT-TRACK FEATURES</span></a></span>
              </div>
              <div style={{ lineHeight: '1.5' }}><span
                style={{ fontSize: '15px' }}><a data-custom-class="link"
                                                href="#caresidents"><span
                style={{ color: 'rgb(89, 89, 89)' }}>7. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span></a></span>
              </div>
              <div style={{ lineHeight: '1.5' }}><span
                style={{ fontSize: '15px' }}><a data-custom-class="link"
                                                href="#policyupdates"><span
                style={{ color: 'rgb(89, 89, 89)' }}>8. DO WE MAKE UPDATES TO THIS NOTICE?</span></a></span>
              </div>
              <div style={{ lineHeight: '1.5' }}><a data-custom-class="link"
                                                    href="#contact"><span
                style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>9. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span></a>
              </div>
              <div style={{ lineHeight: '1.5' }}><a data-custom-class="link"
                                                    href="#request"><span
                style={{ color: 'rgb(89, 89, 89)' }}>10. HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</span></a>
              </div>
              ...
              <div id="infocollect" style={{ lineHeight: '1.5' }}><span
                ...
                data-custom-class="heading_1">1. WHAT INFORMATION DO WE COLLECT?</span></strong><span
                data-custom-class="heading_1"><bdt
                className="block-component"><span
                data-custom-class="body_text" /></bdt></span><bdt
                className="block-component" /><span
                ...
                className="statement-end-if-in-editor"><bdt
                className="statement-end-if-in-editor"><bdt
                className="block-component" /></bdt></bdt></span></span></span></span></bdt></bdt></span></span></span></span></span></span></span>
              </div>
              <div style={{ lineHeight: '1.5' }}><span
                data-custom-class="heading_2" style={{ color: 'rgb(0, 0, 0)' }}><span
                style={{ fontSize: '15px' }}><strong><u><br /></u></strong><strong>Information collected through our App</strong></span></span>
              </div>
              <div>
                <div><br /></div>
                <div style={{ lineHeight: '1.5' }}><span
                  ...
                  data-custom-class="body_text" style={{ fontSize: '15px' }}><bdt
                  className="block-component" /><bdt
                  className="block-component" /><bdt
                  className="block-component" /> push notifications,<bdt
                  className="statement-end-if-in-editor" /><bdt
                  className="forloop-component" /><bdt
                  className="block-component" /><bdt
                  className="forloop-component" /></span> when you use our App.</em></span></span></span></span></span></span>
                </div>
              </div>
              <div style={{ lineHeight: '1.5' }}><br /></div>
              <div style={{ lineHeight: '1.5' }}><span
                style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}><span
                style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}><span
                data-custom-class="body_text">If you use our App, we also collect the following information:<bdt
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div>
                      <bdt className="block-component">
                        <bdt className="forloop-component"><span
                          style={{ fontSize: '15px' }} /></bdt>
                        <span style={{ fontSize: '15px' }}>
                    </span></bdt>
                      <bdt className="forloop-component" />
                    ...
                    <span
                      ...
                      <div style={{ lineHeight: '1.5' }}><br /></div>
                      <div id="infoshare" style={{ lineHeight: '1.5' }}><span
                        style={{ color: 'rgb(127, 127, 127)' }}><span style={{
                        color: 'rgb(89, 89, 89)',
                        fontSize: '15px',
                      }}><span style={{
                        fontSize: '15px',
                        ...
                        color: 'rgb(89, 89, 89)',
                               ...
                               style={{ color: 'rgb(0, 0, 0)' }}><strong><span
                        data-custom-class="heading_1">2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</span></strong></span></span></span></span></span>
                      </div>
                      <div style={{ lineHeight: '1.5' }}><br /></div>
                      <div style={{ lineHeight: '1.5' }}><span style={{
                        fontSize: '15px',
                        color: 'rgb(89, 89, 89)',
                      }}><span style={{
                        fontSize: '15px',
                        color: 'rgb(89, 89, 89)',
                      }}><span data-custom-class="body_text"><strong><em>In Short:</em></strong><em>  We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.</em></span></span></span>
                      </div>
                      <div style={{ lineHeight: '1.5' }}><br /></div>
                      <div style={{ lineHeight: '1.5' }}>
                    <span
                      ...
                      <span
                        ...
                        <span style={{
                          ...
                          <div><span style={{
                            ...
                            className="block-component" /></span></span></span></span></span></span>
                            <div><span style={{
                              fontSize: '15px',
                              color: 'rgb(89, 89, 89)',
                            }}><span style={{
                              ...
                              <div><span style={{
                                ...
                                <div style={{ lineHeight: '1.5' }}><span
                                  ...
                                  fontSize: '15px',
                                  color: 'rgb(89, 89, 89)',
                                }}><span data-custom-class="body_text">More specifically, we may need to process your data or share your personal information in the following situations:</span></span></span>
                                </div>
                                <ul>
                                ...
                                <div><span style={{
                                  ...
                                  className="block-component" /></span></span></span></span></span></span>
                                  <div><span style={{ fontSize: '15px' }}><span
                                    style={{ color: 'rgb(89, 89, 89)' }}><span
                                    data-custom-class="body_text"><bdt
                                    className="block-component" /></span></span></span>
                                    <div><span
                                          ...
                                          <span style={{ fontSize: '15px' }}>
                                            ...
                                            <span style={{
                                              ...
                                              <div><span id="3pwebsites"
                                                ...
                                                color: 'rgb(89, 89, 89)',
                                                       ...
                                                       style={{ color: 'rgb(0, 0, 0)' }}><strong><span
                                                data-custom-class="heading_1">3. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</span></strong></span></span></span></span></span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <br /></div>
                                              <div
                                                ...
                                                <span style={{
                                                  ...
                                                  data-custom-class="body_text"><strong><em>In Short: </em></strong><em> We are not responsible for the safety of any information that you share with third-party providers who advertise, but are not affiliated with, our Website.</em></span></span></span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <br /></div>
                                              <div
                                                ...
                                                <span style={{
                                                  ...
                                                  className="block-component" /><bdt
                                                  className="block-component" /><bdt
                                                  className="block-component" />App<bdt
                                                  className="statement-end-if-in-editor" /></span></span></span></span></span></span></span></span> may contain advertisements from third parties that are not affiliated with us and which may link to other websites, online services or mobile applications. We cannot guarantee the safety and privacy of data you provide to any third parties. Any data collected by third parties is not covered by this privacy notice. We are not responsible for the content or privacy and security practices and policies of any third parties, including other websites, services or applications that may be linked to or from the <span
                                                  style={{
                                                    color: 'rgb(89, 89, 89)',
                                                    fontSize: '15px',
                                                  }}><span
                                                  ...
                                                  className="block-component" /><bdt
                                                  className="block-component" />App<bdt
                                                  className="statement-end-if-in-editor" /></span></span></span></span></span></span></span></span>. You should review the policies of such third parties and contact them directly to respond to your questions.<span
                                                  style={{
                                                    color: 'rgb(89, 89, 89)',
                                                    fontSize: '15px',
                                                  }}><span style={{
                                                  ...
                                                  className="statement-end-if-in-editor"><span
                                                  data-custom-class="body_text" /></bdt></span></span></span></span></span></span></span></span></span></span></span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <br /></div>
                                              <div id="inforetain"
                                                ...
                                                <span
                                                  ...
                                                  color: 'rgb(89, 89, 89)',
                                                         ...
                                                         style={{ color: 'rgb(0, 0, 0)' }}><strong><span
                                                  data-custom-class="heading_1">4. HOW LONG DO WE KEEP YOUR INFORMATION?</span></strong></span></span></span></span></span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <br /></div>
                                              ...
                                              <div
                                                ...
                                                <span style={{
                                                  ...
                                                  data-custom-class="body_text"><bdt
                                                  className="block-component" /><bdt
                                                  className="question">90 days</bdt><bdt
                                              ...
                                              <div id="privacyrights"
                                                ...
                                                <span
                                                  ...
                                                  color: 'rgb(89, 89, 89)',
                                                         ...
                                                         style={{ color: 'rgb(0, 0, 0)' }}><strong><span
                                                  data-custom-class="heading_1">5. WHAT ARE YOUR PRIVACY RIGHTS?</span></strong></span></span></span></span></span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <br /></div>
                                              <div
                                                ...
                                                <span style={{
                                                  ...
                                                  className="block-component" /></em></span></span></span>You may review, change, or terminate your account at any time.</em><span
                                                  style={{ color: 'rgb(89, 89, 89)' }}><span
                                                  style={{ fontSize: '15px' }}><bdt
                                                  className="block-component" /></span></span></span></span></span>
                                              </div>
                                              ...
                                              <div
                                                ...
                                                <span style={{
                                                  ...
                                                  data-custom-class="body_text">If you are a resident in the EEA or UK and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <span
                                                  style={{ fontSize: '15px' }}><span
                                                  style={{ color: 'rgb(89, 89, 89)' }}><span
                                                  data-custom-class="body_text"><span
                                              ...
                                              <div
                                                ...
                                                <span style={{
                                                  ...
                                                  data-custom-class="body_text">If you are a resident in Switzerland, the contact details for the data protection authorities are available here: <span
                                                  style={{ fontSize: '15px' }}><span
                                                  style={{ color: 'rgb(89, 89, 89)' }}><span
                                                  data-custom-class="body_text"><span
                                                  style={{ color: 'rgb(48, 48, 241)' }}><span
                                              ...
                                              <div id="DNT"
                                                ...
                                                <span
                                                  ...
                                                  color: 'rgb(89, 89, 89)',
                                                         ...
                                                         style={{ color: 'rgb(0, 0, 0)' }}><strong><span
                                                  data-custom-class="heading_1">6. CONTROLS FOR DO-NOT-TRACK FEATURES</span></strong></span></span></span></span></span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <br /></div>
                                              ...
                                              <div id="caresidents"
                                                ...
                                                <span
                                                  ...
                                                  color: 'rgb(89, 89, 89)',
                                                         ...
                                                         style={{ color: 'rgb(0, 0, 0)' }}><strong><span
                                                  data-custom-class="heading_1">7. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span></strong></span></span></span></span></span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <br /></div>
                                            ...
                                            <span style={{
                                              ...
                                              <div id="policyupdates"
                                                ...
                                                <span
                                                  ...
                                                  color: 'rgb(89, 89, 89)',
                                                         ...
                                                         style={{ color: 'rgb(0, 0, 0)' }}><strong><span
                                                  data-custom-class="heading_1">8. DO WE MAKE UPDATES TO THIS NOTICE?</span></strong> </span> </span> </span> </span> </span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <em><br /></em></div>
                                              ...
                                              <div id="contact"
                                                ...
                                                <span
                                                  ...
                                                  color: 'rgb(89, 89, 89)',
                                                         ...
                                                         style={{ color: 'rgb(0, 0, 0)' }}><strong><span
                                                  data-custom-class="heading_1">9. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span></strong> </span> </span> </span> </span> </span>
                                              </div>
                                              <div
                                                style={{ lineHeight: '1.5' }}>
                                                <br /></div>
                                              ...
                                              <span style={{
                                                ...
                                                <span
                                                  data-custom-class="body_text">
                                                  If you have questions or comments about this notice, you may email us at quanghuytran.hust@gmail.com.
                                                </span>
                                              </span>
                                                </div>
                                              </div>
